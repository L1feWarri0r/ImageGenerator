...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen bg-gray-900 flex-col items-center justify-between px-24 py-12">
      <h1 className=" text-5xl text-white mb-4">Imagenerator</h1>
      ...
      <div>
        ...
        <button
          className="bg-yellow-600 px-5 py-1 ml-2 h-max rounded-sm disabled:cursor-not-allowed disabled:bg-white-900 transition-colors"
